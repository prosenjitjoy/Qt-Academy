      ...
      ComboBox {
        ...
        onActivated: {
          if (colorSelect.currentIndex == 3) {
            ...
            rootSplitView.rectangleColor = colorSelect.currentText
          }
        }
      }
      ...
      Column {
        ...
        Repeater {
          ...
          delegate: Rectangle {
            ...
            height: 30
            width: scollViewColumn.width

            Text {
              anchors.centerIn: parent
              text: delegateRect.valueText
              font.pointSize: 15
            }
            ...
            MouseArea {
              ...
              onReleased: {
                ...
                colorPopup.close()
                rootSplitView.rectangleColor = delegateRect.valueText
              }
            }
          }
        }
