...
ApplicationWindow {
  ...
  menuBar: MenuBar {
    Menu {
      ...
      MenuItem {
        text: "Input Controls"
        enabled: !(mainWindow.lastSelectedView == 0)

        onTriggered: {
          mainStackView.pop()
          mainStackView.push("InputControls.qml")
      ...
      MenuItem {
        text: "Feedback"
        enabled: !(mainWindow.lastSelectedView == 1)

        onTriggered: {
          mainStackView.pop()
          mainStackView.push("Feedback.qml", {
      ...
      MenuItem {
        text: "Qt Logos"
        enabled: !(mainWindow.lastSelectedView == 2)

        onTriggered: {
          mainStackView.pop()
          mainStackView.push("LogosSwipeView.qml")
      ...
      MenuItem {
        text: "Title View"
        enabled: !(mainWindow.lastSelectedView == 3)
