...
Column {
    ...
    AnimatedImage {
        ...
        playing: root.controller.status !== LumberSawController.IdleStatus
        source: root.controller.status === LumberSawController.ErrorStatus ? "assets/alert.gif" : "assets/circular-saw.gif"
